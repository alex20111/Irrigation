...
public class WorkerSql {
	...
	public List<Worker> loadAllWorkers(boolean onlyManaged, boolean currStatus, boolean getWeather) throws SQLException{
		...
		while (rs.next()) {
			...
			if (currStatus){				
				...
				ResultSet rs2 = con.createQuery(query2)
			...
			if (getWeather){
				...
				ResultSet rsWeather = con.createQuery(weatherQuery).setParameter("workerId", worker.getWorkId()).getSelectResultSet();
	...
	public Worker loadWorkerById(String workerId, boolean getCurrentStatus, boolean loadWeather) throws SQLException{
		...
		ResultSet rs = con.createQuery(query).setParameter("id", workerId)
				.getSelectResultSet();
...
//				}
			...
			if (loadWeather){
				...
				ResultSet weatherRS = con.createQuery(weatherQuery).setParameter("id", workerId)
						.getSelectResultSet();
	...
	public WorkerStatus loadCurrentStatusByWorkerId(String workerId, DBConnection con) throws SQLException{
		...
		if (con == null){
			...
			con = new DBConnection(Constants.url, Constants.dbUser, Constants.dbPassword);
	...
	public void addWorkerStatus(WorkerStatus ws) throws SQLException{
		DBConnection con = new DBConnection(Constants.url, Constants.dbUser, Constants.dbPassword);
	...
	public void deleteWorkerStatus(String workerId) throws SQLException{
	...
	public void deleteWorkerWeather(String workerId) throws SQLException{
	...
	public List<WorkerStatus> loadAllWorkerStatusById(String workerId, Date from, Date to) throws SQLException{
	...
	public List<Event> loadAllWorkerCommentsByDates(Date fromDate, Date toDate) throws SQLException{
